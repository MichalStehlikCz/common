...
class StringParserTest {
  ...
  @ParameterizedTest
  @MethodSource
  void readUnsignedIntTest(String string, int pos, int minChars, int maxChars, boolean exception,
      int result,
      int endPos) {
    var parser = new StringParser(string);
    parser.setPos(pos);
  ...
  @ParameterizedTest
  @MethodSource
  void readUnsignedIntTest2(String string, int pos, int chars, boolean exception, int result,
      int endPos) {
    var parser = new StringParser(string);
    parser.setPos(pos);
    if (exception) {
  ...
  @SuppressWarnings("squid:S00107")
    // we do not mind too many parameters in test method
  void readIntTest(String string, int pos, int minChars, int maxChars,
      StringParser.SignHandling signHandling,
  ...
  @ParameterizedTest
  @MethodSource
  void readString0Test(String string, int pos, @Nullable String result, int endPos,
