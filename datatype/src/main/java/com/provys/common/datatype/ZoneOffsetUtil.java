...
public class ZoneOffsetUtil {
    ...
    /**
     * Regular expression for offset part of time information. Lenient form allows offset range -18 to +18 hours and
     * supports same formats as ZoneOffset (in addition to strict formats z for GMT, [+-]HHMI, [+-]HH:MI:SS and
     * [+-]HHMISS
     */
    public static final String REGEX_LENIENT = "[zZ]|(?:[+-](?:0[0-9]|1[0-8]):[0-5][0-9](?::[0-5][0-9])?)|" +
            "[+-](?:0?[0-9]|1[0-8])|" +
